...
// const farenheits = celsius.map((element) => element * 1.8 + 32);

// const farenheits = celsius.map((element) => {
...
// const getModels = (viecles) => {
//   const modelsArr = viecles.map((car) => {
//     return car.model;
//   });
//   return modelsArr;
// };
...
// const getModels = (viecles) => {
//   return viecles.map((car) => {
//     return car.model;
//   });
// };

// const getModels = (viecles) => {
//   return viecles.map((car) => car.model);
// };

// const getModels = (viecles) => viecles.map((car) => car.model);

// const getModels = (viecles) => viecles.map(({ model }) => model);
